/**
 * BarndAI browser client adapter (studio package copy).
 * Mirrors src/lib/barndApi.js — studio cannot import from repo root at build time.
 */
...
/** Drop-in replacement for muapi.generateImage (apiKey ignored for mock Barnd routes). */
